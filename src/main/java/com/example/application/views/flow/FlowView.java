...
public class FlowView extends VerticalLayout {
    ...
    public FlowView() {
        ...
        // min of 0.5x, max of 3.0x, a step of 0.25x, and an initial value of 1.0x.
        // 2. Add a label and helper text
        // 3. Make the slider display the minimum and maximum selectable speed (0.5 and 3.0)
        ...
        // 2. Show the selected range in a separate HTML element next to the range slider,
